...
const EditContact = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/Users/${contactId}`)
      .then(response => {
  ...
  const handleFormSubmit = (event) => {
    ...
    axios.put(`http://localhost:8080/Users/${contactId}`, updatedContact)
      .then(response => {
    ...
    <div className="container cont-bg mt-4">
      <div className="row mb-5">
        <div className="col-md-6">
          <img src="/images/editContact.jpg" alt="Contact" className="img-fluid" />
        </div>
        <div className="col-md-6">
